...
<body background-image:url("ebanking/resources/image/ab.jpg")> 
   ...
   <td colspan="2"><table width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
      <tr>
        <th colspan="2" scope="col"><div class="box1">
         ...
         <center><img src="./jsp/image/ab.jpg"></center>
      </tr>
         <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <th width="50%" scope="col"><form id="form1" name="form1" method="post" action="doLogin">
          <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" style="border:#000000 solid 2px; padding:5px;">
            ...
            <tr>
              <td width="28%" rowspan="3"><div align="center"><img src="./jsp/image/log.png" width="48" height="48" /></div></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="3">Want to Create a New Account? <a href="./jsp/register.jsp">Click Here</a> </td>
              </tr>
              <tr>
              <td width="24%"></td>
              <td width="48%"><label>
