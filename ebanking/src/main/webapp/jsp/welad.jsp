...
<div id="ddblueblockmenu">
  ...
  %>
    <li><a href="jsp/welad.jsp">Welcome,&nbsp;<%=uname %></a></li>
       <li><a href="jsp/emp.jsp">Employee Management</a></li>
	<li><a href="jsp/repad.jsp">Report</a></li>
